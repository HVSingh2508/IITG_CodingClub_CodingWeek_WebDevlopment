...
.then(function(data){
    ...
    for(var i = 0;i < data.products.length;i++){
        ...
        divElem.setAttribute("onClick","clk("+i+")");
    ...
    for(var i = 0; i < data.products.length;i++){
        ...
        <div class="card-body">
            ...
            <div class="dis_class des${i}" style="display: none">Discount ${data.products[i].discountPercentage} %</div>
...
function clk(i){
    document.querySelector(".class"+i).style.display = "";
}